...
export const SalonManager: React.FC = () => {
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                    ...
                                    <div className="space-y-6">
                                        <div>
                                            ...
                                            <input required className="w-full h-11 px-4 rounded-lg border border-border bg-gray-50 focus:bg-white focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-colors" value={editingSalon.name} onChange={e => setEditingSalon({...editingSalon, name: e.target.value})} />
                                        </div>
                                        <div className="grid grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <select 
                                                    ...
                                                    onChange={e => setEditingSalon({...editingSalon, district: e.target.value})}
                                                >
                                                    <option value="">Seçiniz</option>
                                        ...
                                        <div>
                                            ...
                                            <div className="flex gap-2">
                                                <textarea required rows={3} className="flex-1 p-4 rounded-lg border border-border bg-gray-50 focus:bg-white focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-colors" value={editingSalon.location} onChange={e => setEditingSalon({...editingSalon, location: e.target.value})}></textarea>
                                            </div>
                                            <button 
                                                type="button" 
                                        ...
                                        <div>
                                            ...
                                            <input type="number" required className="w-full h-11 px-4 rounded-lg border border-border bg-gray-50 focus:bg-white focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-colors" value={editingSalon.startPrice} onChange={e => setEditingSalon({...editingSalon, startPrice: Number(e.target.value)})} />
                                        </div>
                                        <div>
                                            <label className="block text-sm font-bold text-text-main mb-2">Görsel URL</label>
                                            <input className="w-full h-11 px-4 rounded-lg border border-border bg-gray-50 focus:bg-white focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-colors" value={editingSalon.image} onChange={e => setEditingSalon({...editingSalon, image: e.target.value})} />
                                        </div>
                                    </div>
                                        ...
                                        <div className="space-y-2 pt-4 border-t border-gray-100">
                                            ...
                                            <div className="flex items-center gap-2 mt-2">
                                                <input 
                                                    ...
                                                    onChange={e => setEditingSalon({...editingSalon, isSponsored: e.target.checked})}
                                                />
