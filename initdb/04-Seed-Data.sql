-- =============================================
-- 04-Seed-Data.sql
-- Temel tanımlamalar (Şehirler, Tipler, Hizmetler)
-- Not: Salons ve ilgili tablolarda ID artik bigint olduğu için sayisal kullanilmistir.
-- =============================================
...
-- 5. TEST PROFILES (owner UUID - if the user table uses id as bigint, wait! Let's check VDS Base Schema 01)
-- Not: Supabase 'auth.users' genelde UUID kullanir. public.profiles da uuid'dir.
...
-- 6. SALONS (BIGINT IDs)
-- ID olarak 999 verelim
INSERT INTO public.salons (id, name, description, address, city_id, district_id, type_id, owner_id, geo_latitude, geo_longitude, is_sponsored, status, image) VALUES 
(999, 'Elite Barber Shop', 'İzmir''in kalbinde, modern ve geleneksel tıraşın buluşma noktası.', 'Kordon Boyu No: 234, Konak', '7e8b9c0d-1e2f-3a4b-5c6d-7e8f9a0b1c2d', '1a2b3c4d-5e6f-7a8b-9c0d-1e2f3a4b5c6d', 'd0a403a7-44a3-45d4-b489-2b6d3cc311c6', '00000000-0000-0000-0000-000000000001', 38.4237, 27.1428, true, 'APPROVED', 'https://images.unsplash.com/photo-1585747860715-2ba37e788b70?w=800')
ON CONFLICT (id) DO NOTHING;

-- 7. SALON SERVICES (BIGINT IDs)
INSERT INTO public.salon_services (id, salon_id, global_service_id, price, duration_min) VALUES 
(9991, 999, 'bcd2f8ee-a2c7-4188-9de1-83923a565c0b', 250.00, 45),
(9992, 999, 'a1b2c3d4-e5f6-4a8b-9c0d-e1f2a3b4c5d6', 500.00, 90)
ON CONFLICT DO NOTHING;

-- 8. SALON WORKING HOURS (BIGINT IDs)
INSERT INTO public.salon_working_hours (salon_id, day_of_week, start_time, end_time, is_closed) VALUES 
(999, 1, '09:00', '20:00', false),
(999, 2, '09:00', '20:00', false),
(999, 3, '09:00', '20:00', false),
(999, 4, '09:00', '20:00', false),
(999, 5, '09:00', '20:00', false),
(999, 6, '09:00', '18:00', false),
(999, 0, '00:00', '00:00', true)
ON CONFLICT DO NOTHING;
