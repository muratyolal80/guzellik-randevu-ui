...
const AuthProvider = ({ children })=>{
        ...
        "AuthProvider.useCallback[refreshUser]": async ()=>{
            try {
                ...
                const timeoutPromise = new Promise({
                    "AuthProvider.useCallback[refreshUser]": (_, reject)=>setTimeout({
                            "AuthProvider.useCallback[refreshUser]": ()=>reject(new Error('Session check timeout'))
                        }["AuthProvider.useCallback[refreshUser]"], 5000)
                }["AuthProvider.useCallback[refreshUser]"]);
                const { data, error } = await Promise.race([
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getSession(),
                    timeoutPromise
                ]);
    ...
    const signUp = async (email, password, firstName, lastName, role = 'CUSTOMER')=>{
        const redirectUrl = ("TURBOPACK compile-time truthy", 1) ? `${window.location.origin}/` : "TURBOPACK unreachable";
...
"[project]/context/TenantContext.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const TenantContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])({
    salonId: null,
    salon: null,
    plan: null,
    setPlan: ()=>{},
...
const TenantProvider = ({ children })=>{
    _s();
    const { user, isOwner, isStaff } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    const [salonId, setSalonId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const refreshSalonId = async ()=>{
        ...
        try {
            ...
            if (isOwner) {
                ...
                const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('salons').select('*').eq('owner_id', user.id);
                if (error) {
                    if (error.code !== 'PGRST116') {
                    ...
                    const savedBranchId = ("TURBOPACK compile-time truthy", 1) ? localStorage.getItem(`active_branch_${user.id}`) : "TURBOPACK unreachable";
                ...
                const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('staff').select('salon_id').eq('user_id', user.id);
                if (error) {
                    ...
                    setSalonId(sId);
                    if (sId) {
                        const { data: salonData } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('salons').select('*').eq('id', sId).single();
                        setSalon(salonData);
...
_s(TenantProvider, "xwEcm6VcULk2aaCVaMIJrvebmx4=", false, function() {
    return [
...
_s1(useTenant, "gDsCjeeItUuvgOWf1v4qoK9RF6k=");
var _c;
...
"[project]/services/db/db_core.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const isSupabaseConfigured = ()=>{
    return typeof __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabaseUrl"] === 'string' && __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabaseUrl"].includes('localhost:8000');
};
const MasterDataService = {
   ...
   */ async createSalonType (type) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_types").insert(type).select().single();
        if (error) throw error;
        return data;
    },
    /**
   ...
   */ async updateSalonType (id, updates) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_types").update(updates).eq("id", id).select().single();
        if (error) throw error;
        return data;
    },
    /**
   ...
   */ async deleteSalonType (id) {
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_types").delete().eq("id", id);
        if (error) throw error;
    },
    /**
   ...
   */ async createServiceCategory (category) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("service_categories").insert(category).select().single();
        if (error) throw error;
        return data;
    },
    /**
   ...
   */ async updateServiceCategory (id, updates) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("service_categories").update(updates).eq("id", id).select().single();
        if (error) throw error;
        return data;
    },
    /**
   ...
   */ async deleteServiceCategory (id) {
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("service_categories").delete().eq("id", id);
        if (error) throw error;
    },
    /**
   ...
   */ async getServiceCategoriesForSalonTypes (typeIds) {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_type_categories").select(`
   ...
   */ async getGlobalServicesByCategories (categoryIds) {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("global_services").select("*").in("category_id", categoryIds).order("name");
        if (error) {
   ...
   */ async createGlobalService (service) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("global_services").insert(service).select().single();
        if (error) throw error;
        return data;
    },
    /**
   ...
   */ async updateGlobalService (id, updates) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("global_services").update(updates).eq("id", id).select().single();
        if (error) throw error;
        return data;
    },
    /**
   ...
   */ async deleteGlobalService (id) {
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("global_services").delete().eq("id", id);
        if (error) throw error;
    },
    /**
...
const GlobalSearchService = {
   ...
   */ async search (query) {
        ...
        const [salonsResp, servicesResp] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salons").select("id, name, image, slug, city:cities(name)").ilike("name", `%${query}%`).eq("status", "APPROVED").limit(5),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("global_services").select("id, name, slug, category:service_categories(name)").ilike("name", `%${query}%`).limit(5)
        ]);
...
const PlatformService = {
   ...
   */ async getSetting (key) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("platform_settings").select("value").eq("key", key).maybeSingle();
        if (error) throw error;
        return data?.value;
    },
    /**
   ...
   */ async updateSetting (key, value) {
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("platform_settings").upsert({
            key,
            value,
...
"[project]/services/db/db_salon.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const SalonDataService = {
   ...
   */ async getSalons () {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_details").select("*").eq("status", "APPROVED") // Only show approved salons
        .order("is_sponsored", {
            ascending: false
   ...
   */ async getSalonsByMembership (userId) {
        ...
        const { data: memberships, error: memError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_memberships").select("salon_id").eq("user_id", userId).eq("is_active", true);
        if (memError) throw memError;
        if (!memberships || memberships.length === 0) return [];
        // Then fetch the salon details
        const salonIds = memberships.map((m)=>m.salon_id);
        const { data: salons, error: salonError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_details").select("*").in("id", salonIds);
   ...
   */ async getSalonBySlug (slug) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_details").select("*").eq("slug", slug).single();
        if (error) throw error;
        return data ? this.mapSalonDetail(data) : null;
    },
    /**
   ...
   */ async searchSalons (filters) {
        ...
        if (filters.typeId) {
            ...
            const { data: assigned } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_assigned_types").select("salon_id").eq("type_id", filters.typeId);
   ...
   */ async createSalon (salon, customHours, initialServices) {
        ...
        const { data: existingSalons } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salons").select("id").eq("owner_id", salon.owner_id).limit(1);
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salons").insert(dbSalon).select().single();
        if (error) {
        ...
        if (type_ids && type_ids.length > 0) {
            ...
            const { error: assignError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_assigned_types").insert(assignments);
        ...
        const { error: hoursError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_working_hours").insert(hoursToInsert);
        if (hoursError) {
        ...
        if (initialServices && initialServices.length > 0) {
            ...
            const { error: servicesError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_services").insert(servicesToInsert);
            if (servicesError) {
   ...
   */ async updateSalon (id, updates) {
        ...
        // Update main table
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salons").update(salonUpdates).eq("id", id).select();
        if (error) {
        ...
        if (type_ids && type_ids.length > 0) {
            ...
            const { error: deleteError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_assigned_types").delete().eq("salon_id", id);
            if (deleteError) {
            ...
            const { error: insertError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_assigned_types").insert(assignments);
   ...
   */ async updateSalonPlan (id, plan) {
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salons").update({
            plan
        }).eq("id", id);
        if (error) throw error;
    },
   ...
   */ async deleteSalon (id) {
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salons").delete().eq("id", id);
        if (error) throw error;
    },
    /**
   * Get salon details by owner user ID (Returns list of all salons owned)
   */ async getSalonsByOwner (ownerId) {
        const { data: salonIds, error: salonError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salons").select("id").eq("owner_id", ownerId);
        if (salonError || !salonIds || salonIds.length === 0) return [];
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_details").select("*").in("id", salonIds.map((s)=>s.id));
        if (error) throw error;
        return (data || []).map((s)=>this.mapSalonDetail(s));
    },
    /**
   ...
   */ async getAllSalonsForAdmin () {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_details").select("*").order("created_at", {
            ascending: false
        });
        if (error) throw error;
        return (data || []).map((s)=>this.mapSalonDetail(s));
   ...
   */ async getSalonWorkingHours (salonId) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_working_hours").select("*").eq("salon_id", salonId).order("day_of_week");
        if (error) throw error;
        return data || [];
    },
    /**
   ...
   */ async updateSalonWorkingHours (id, updates) {
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_working_hours").update(updates).eq("id", id);
        if (error) throw error;
    },
    /**
   ...
   */ async initializeDefaultWorkingHours (salonId) {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_working_hours").insert(defaultHours).select();
        if (error) throw error;
        return data || [];
    },
    /**
   ...
   */ async getUsageStats (salonId) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_usage_stats").select("*").eq("salon_id", salonId).maybeSingle();
        if (error) throw error;
        return data;
    }
};
const WorkingHoursService = {
   ...
   */ async createStaff (staffData) {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("staff").insert({
            ...staffData,
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("working_hours").insert(defaultHours);
        return data;
    },
    /**
   * Update existing staff
   */ async updateStaff (id, updates) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("staff").update({
            ...updates,
            updated_at: new Date().toISOString()
...
const ReviewService = {
   ...
   */ async getReviewsBySalon (salonId, limit = 50) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("verified_reviews_view") // Use the view for extra details
        ...
        if (error) {
            ...
            const { data: fallbackData, error: fallbackError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("reviews").select("*").eq("salon_id", salonId).order("created_at", {
                ascending: false
            }).limit(limit);
        ...
        if (reviewIds.length > 0) {
            const { data: imageData } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("review_images").select("*").in("review_id", reviewIds);
    ...
    async createReview (review) {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("reviews").insert(reviewData).select().single();
        if (error) {
   ...
   */ async getReviewableAppointments (userId, salonId) {
        ...
        let query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("appointments").select("*, salon:salons(name, logo_url)").eq("customer_id", userId).eq("status", "COMPLETED").order("end_time", {
            ascending: false
        });
        if (salonId) {
        ...
        let reviewQuery = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("reviews").select("appointment_id").eq("user_id", userId).not("appointment_id", "is", null);
        if (salonId) {
...
const GalleryService = {
   ...
   */ async getSalonGallery (salonId) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_gallery").select("*").eq("salon_id", salonId).order("display_order", {
            ascending: true
        });
        if (error) throw error;
        return data || [];
   ...
   */ async addGalleryImage (image) {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_gallery").insert(image).select().single();
        if (error) throw error;
        return data;
    },
    /**
   ...
   */ async updateGalleryImage (id, updates) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_gallery").update(updates).eq("id", id).select().single();
        if (error) throw error;
        return data;
    },
    /**
   ...
   */ async deleteGalleryImage (id) {
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_gallery").delete().eq("id", id);
        if (error) throw error;
    },
    /**
   ...
   */ async setCoverImage (salonId, imageId) {
        ...
        const { error: unsetErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_gallery").update({
            is_cover: false
        }).eq("salon_id", salonId);
        if (unsetErr) throw unsetErr;
        // 2. Set the new cover image
        const { error: setErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_gallery").update({
            is_cover: true
        }).eq("id", imageId);
        if (setErr) throw setErr;
        // 3. Update the main salons table image cache
        const { data: imgData } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_gallery").select("image_url").eq("id", imageId).single();
        if (imgData) {
            const { error: salonErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salons").update({
   ...
   */ async getReviewImages (reviewId) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("review_images").select("*").eq("review_id", reviewId);
        if (error) throw error;
        return data || [];
    },
    /**
   ...
   */ async addReviewImage (image) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("review_images").insert(image).select().single();
        if (error) throw error;
        return data;
    }
};
const FavoriteService = {
   ...
   */ async getFavorites (userId) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_favorites").select(`
        *,
        salon:salon_details(*)
   ...
   */ async isFavorite (userId, salonId) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_favorites").select("id").eq("user_id", userId).eq("salon_id", salonId).maybeSingle();
   ...
   */ async toggleFavorite (userId, salonId) {
        ...
        if (isFav) {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_favorites").delete().eq("user_id", userId).eq("salon_id", salonId);
            if (error) throw error;
            return false;
        } else {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_favorites").insert({
                user_id: userId,
                salon_id: salonId
            });
            if (error) throw error;
...
"[project]/services/db/db_staff.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const StaffService = {
   ...
   */ async createStaff (staffData, customWorkingHours) {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("working_hours").insert(hoursToInsert);
        // 3. Auto-link to profile if email matches
        if (staffData.email && !staffData.user_id) {
            const { data: profile } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("profiles").select("id").eq("email", staffData.email).single();
            if (profile) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("staff").update({
                    user_id: profile.id
                }).eq("id", data.id);
   ...
   */ async updateWorkingHours (id, updates) {
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("working_hours").update(updates).eq("id", id);
        if (error) throw error;
    },
    async linkStaffToServices (staffId, salonId, serviceIds) {
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("staff_services").insert(assignments);
        if (error) throw error;
    }
};
const ServiceService = {
   ...
   */ async getAllSalonServices () {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_service_details").select("salon_id, service_name");
        if (error) throw error;
        return data || [];
    },
    /**
   ...
   */ async getServiceById (id, salonId) {
        let query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_service_details").select("*").eq("id", id);
        if (salonId) {
            query = query.eq("salon_id", salonId);
        }
   ...
   */ async createService (serviceData) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_services").insert(serviceData).select().single();
        if (error) throw error;
        return data;
    },
    /**
   ...
   */ async updateService (id, updates, salonId) {
        let query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_services").update(updates).eq("id", id);
        if (salonId) {
            query = query.eq("salon_id", salonId);
        }
   ...
   */ async deleteService (id, salonId) {
        let query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_services").delete().eq("id", id);
        if (salonId) {
            query = query.eq("salon_id", salonId);
        }
...
const StaffReviewService = {
   ...
   */ async getReviewsByStaff (staffId, limit = 50) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("staff_reviews").select("*").eq("staff_id", staffId).order("created_at", {
            ascending: false
        }).limit(limit);
        if (error) throw error;
        return data || [];
   ...
   */ async getReviewsBySalon (salonId, limit = 50) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("staff_reviews_detailed").select("*").eq("salon_id", salonId).order("created_at", {
            ascending: false
        }).limit(limit);
        if (error) throw error;
        return data || [];
    ...
    async createStaffReview (review) {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("staff_reviews").insert(reviewData).select().single();
        if (error) {
   ...
   */ async hasReviewed (userId, staffId, appointmentId) {
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("staff_reviews").select("id").eq("user_id", userId).eq("staff_id", staffId).eq("appointment_id", appointmentId).maybeSingle();
        return !!data;
    },
    /**
   * Get appointments eligible for staff review
   */ async getReviewableAppointmentsForStaff (userId, staffId) {
        const { data: appointments, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("appointments").select("*").eq("customer_id", userId).eq("staff_id", staffId).eq("status", "COMPLETED").order("end_time", {
            ascending: false
        });
        if (error) throw error;
        if (!appointments || appointments.length === 0) return [];
        const { data: existing } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("staff_reviews").select("appointment_id").eq("user_id", userId).eq("staff_id", staffId).not("appointment_id", "is", null);
   ...
   */ async deleteReview (reviewId) {
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("staff_reviews").delete().eq("id", reviewId);
        if (error) throw error;
    }
};
const StaffAnalyticsService = {
   ...
   */ async getTodayAppointmentsByStaff (staffId) {
        ...
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("appointments").select("id", {
            count: "exact"
   ...
   */ async getWeeklyOccupancyByStaff (staffId, weekStart) {
        ...
        for (const date of weekDays){
            ...
            const { data: hours } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("working_hours").select("start_time, end_time, is_day_off").eq("staff_id", staffId).eq("day_of_week", date.getDay()).single();
            ...
            const { data: appts } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("appointments").select(`
          start_time,
          end_time,
   ...
   */ async getCurrentAvailability (staffId) {
        ...
        const { data: current } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("appointments").select(`
        *,
      ...
      `).eq("staff_id", staffId).lte("start_time", nowStr).gte("end_time", nowStr).in("status", [
        ...
        const { data: next } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("appointments").select("start_time").eq("staff_id", staffId).gte("start_time", nowStr).order("start_time", {
            ascending: true
        }).limit(1).single();
        return {
            isAvailable: true,
...
"[project]/services/db/db_support.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const SupportService = {
   ...
   */ async getTickets (userId) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("support_tickets").select("*").eq("user_id", userId).order("created_at", {
            ascending: false
        });
        if (error) throw error;
        return data || [];
   ...
   */ async createTicket (userId, subject, category, message) {
        const { data: ticket, error: ticketError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("support_tickets").insert({
            user_id: userId,
            subject,
            category,
            message,
        ...
        const { error: msgError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("ticket_messages").insert({
            ticket_id: ticket.id,
            sender_id: userId,
   ...
   */ async getTicketById (ticketId) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("support_tickets").select("*").eq("id", ticketId).single();
        if (error) throw error;
        return data;
    },
    /**
   ...
   */ async getTicketMessages (ticketId) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("ticket_messages").select("*").eq("ticket_id", ticketId).order("created_at", {
            ascending: true
        });
        if (error) throw error;
        return data || [];
   ...
   */ async getAllTickets () {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("support_tickets").select(`
        *,
   ...
   */ async addMessage (ticketId, senderId, senderRole, message) {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("support_tickets").update({
            updated_at: new Date().toISOString()
        }).eq("id", ticketId);
    },
    /**
   ...
   */ async resolveTicket (ticketId) {
        ...
        const { error: rpcError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].rpc("resolve_own_ticket", {
            p_ticket_id: ticketId
        });
        if (rpcError) {
            console.warn("RPC resolution failed, falling back to direct update:", rpcError);
            // Fallback for Admin or if logic changes
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("support_tickets").update({
                status: "RESOLVED",
                updated_at: new Date().toISOString()
            }).eq("id", ticketId);
            if (error) throw error;
...
const NotificationService = {
   ...
   */ async getNotifications (userId) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("notifications").select("*").eq("user_id", userId).order("created_at", {
            ascending: false
        });
        if (error) throw error;
        return data || [];
   ...
   */ async markAsRead (id) {
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("notifications").update({
            is_read: true
        }).eq("id", id);
        if (error) throw error;
    },
   ...
   */ async sendNotification (notification) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("notifications").insert({
            ...notification,
            is_read: false,
            created_at: new Date().toISOString()
        }).select().single();
...
const AuditLogService = {
   ...
   */ async logAction (log) {
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("audit_logs").insert(log);
        if (error) {
   ...
   */ async getLogsBySalon (salonId, limit = 100) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("audit_logs").select(`
        *,
        user:profiles(full_name, email)
...
"[project]/services/db/db_appointments.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const AppointmentService = {
   ...
   */ async getAppointmentById (id, salonId) {
        let query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("appointments").select("*").eq("id", id);
        if (salonId) {
            query = query.eq("salon_id", salonId);
        }
        const { data, error } = await query.single();
   ...
   */ async updateAppointmentStatus (id, status, salonId) {
        let query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("appointments").update({
            status
        }).eq("id", id);
        if (salonId) {
            query = query.eq("salon_id", salonId);
        ...
        if (salonId) {
            __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$db$2f$db_support$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuditLogService"].logAction({
                salon_id: salonId,
   ...
   */ async updateAppointment (id, updates, salonId) {
        let query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("appointments").update(updates).eq("id", id);
        if (salonId) {
            query = query.eq("salon_id", salonId);
        }
        const { data, error } = await query.select().single();
...
const InviteService = {
   ...
   */ async createInvite (invite) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("invites").insert({
            ...invite,
   ...
   */ async getInviteByToken (token) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("invites").select("*, salon:salons(name)").eq("token", token).eq("status", "PENDING").single();
   ...
   */ async acceptInvite (inviteId, userId) {
        const { data: invite, error: fetchErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("invites").select("*").eq("id", inviteId).single();
        if (fetchErr) throw fetchErr;
        // 1. Create membership
        const { error: memErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_memberships").insert({
            user_id: userId,
        ...
        const { error: updErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("invites").update({
            status: "ACCEPTED",
...
const CampaignService = {
   ...
   */ async validateCoupon (code, salonId, amount) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("coupons").select("*").eq("code", code.toUpperCase()).eq("salon_id", salonId).eq("is_active", true).single();
   ...
   */ async getSalonCoupons (salonId) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("coupons").select("*").eq("salon_id", salonId).order("created_at", {
            ascending: false
        });
        if (error) throw error;
        return data || [];
   ...
   */ async createCoupon (coupon) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("coupons").insert(coupon).select().single();
        if (error) throw error;
        return data;
    },
    /**
   ...
   */ async deleteCoupon (id) {
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("coupons").delete().eq("id", id);
        if (error) throw error;
    },
    /**
   * Get all active packages for a salon
   */ async getSalonPackages (salonId) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("packages").select(`
        *,
   ...
   */ async createPackage (packageData, services) {
        ...
        const { data: pkg, error: pkgError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("packages").insert(packageData).select().single();
        ...
        const { error: srvError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("package_services").insert(packageServices);
   ...
   */ async deletePackage (id) {
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("packages").delete().eq("id", id);
        if (error) throw error;
    }
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
"[project]/services/db/db_finance.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const PaymentService = {
    ...
    async createTransaction (transaction) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("transactions").insert(transaction).select().single();
        if (error) throw error;
        return data;
    },
    // Get transactions for a salon (Owner view)
    async getSalonTransactions (salonId) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("transactions").select("*").eq("salon_id", salonId).order("created_at", {
            ascending: false
        });
        if (error) throw error;
        return data;
    ...
    async getCustomerTransactions (customerId) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("transactions").select("*, salons(name)").eq("customer_id", customerId).order("created_at", {
            ascending: false
        });
        if (error) throw error;
        return data;
   ...
   */ async recordPayment (payment) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("payment_history").insert(payment).select().single();
        if (error) throw error;
        return data;
    },
    /**
   ...
   */ async getSalonPaymentHistory (salonId) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("payment_history").select("*").eq("salon_id", salonId).order("created_at", {
            ascending: false
        });
        if (error) throw error;
        return data;
...
const SubscriptionService = {
   ...
   */ async getSalonSubscription (salonId) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("subscriptions").select("*, subscription_plans(*)").eq("salon_id", salonId).order("created_at", {
            ascending: false
        }).limit(1).maybeSingle();
        if (error) throw error;
        return data;
   ...
   */ async checkLimit (salonId, resourceType) {
        ...
        if (resourceType === "staff") {
            const { count } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("staff").select("*", {
                count: "exact",
                head: true
            }).eq("salon_id", salonId);
            current = count || 0;
            ...
            const { data: currentSalon } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salons").select("owner_id").eq("id", salonId).maybeSingle();
            if (currentSalon?.owner_id) {
                const { count } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salons").select("*", {
                    count: "exact",
                    head: true
            ...
            const { count } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_gallery").select("*", {
                count: "exact",
                head: true
            }).eq("salon_id", salonId);
            current = count || 0;
   ...
   */ async createSubscriptionRequest (salonId, planId, paymentMethod, billingCycle = "MONTHLY") {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("subscriptions").upsert({
            salon_id: salonId,
            plan_id: planId,
            status: "PENDING",
   ...
   */ async notifyBankTransfer (subscriptionId, salonId, amount) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("payment_history").insert({
            salon_id: salonId,
   ...
   */ async updatePlan (planId, updates) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("subscription_plans").update(updates).eq("id", planId).select().single();
        if (error) throw error;
        return data;
    },
    /**
   ...
   */ async activateSalonAndSubscription (salonId, subscriptionId, adminNote) {
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].rpc("activate_salon_and_subscription", {
            p_salon_id: salonId,
...
const SubmerchantService = {
   ...
   */ async getBySalonId (salonId) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_sub_merchants").select("*").eq("salon_id", salonId).maybeSingle();
        if (error) throw error;
        return data;
    },
    /**
   ...
   */ async saveRegistration (salonId, registrationData) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salon_sub_merchants").upsert({
            salon_id: salonId,
            ...registrationData,
            updated_at: new Date().toISOString()
        }).select().single();
...
const FinanceService = {
   ...
   */ async getPendingPayments () {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("payment_history").select("*, salons(name, owner_id)").eq("status", "PENDING").order("created_at", {
            ascending: false
        });
        if (error) throw error;
        return data;
   ...
   */ async updatePaymentStatus (paymentId, status, adminNote) {
        const { data: payment, error: pError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("payment_history").select("*").eq("id", paymentId).single();
        if (pError) throw pError;
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("payment_history").update({
            status,
            metadata: {
                ...payment.metadata,
        ...
        if (status === "SUCCESS" && payment.payment_type === "SUBSCRIPTION" && payment.subscription_id) {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("subscriptions").update({
                status: "ACTIVE"
            }).eq("id", payment.subscription_id);
            // Activate salon (Set to APPROVED)
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salons").update({
                status: "APPROVED",
                is_verified: true
   ...
   */ async getFinancialReports (filter = {}) {
        let query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("payment_history").select("*");
...
"[project]/services/db/db_user.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const DashboardService = {
   ...
   */ async getDashboardData (userId) {
        ...
        const upcomingQuery = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("appointments").select("*", {
            count: "exact",
            head: true
        }).eq("status", "CONFIRMED").gt("start_time", new Date().toISOString()).eq("customer_id", userId);
        const reviewQuery = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("reviews").select("*", {
            count: "exact",
            head: true
        }).eq("user_id", userId);
        const spendingQuery = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("appointments").select(`
      ...
      `).in("status", [
        ...
        const nextAppointmentQuery = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("appointments").select(`
        *,
        salon:salons (
          name,
          address,
   ...
   */ async getOwnerDashboardData (salonId) {
        ...
        const { data: appts, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("appointments").select(`
        id,
        start_time,
        status,
      ...
      `).eq("salon_id", salonId).gte("start_time", thirtyDaysAgoStr).in("status", [
        ...
        // 2. Staff Performance
        const { data: staffData } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("staff").select(`
        id,
        name,
   ...
   */ async getPlatformStats () {
        ...
        const [salons, appointments, staff] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("salons").select("*", {
                count: "exact",
                head: true
            }),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("appointments").select("*", {
                count: "exact",
                head: true
        ...
        const { data: revenueData } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("appointments").select("service:salon_services(price)").eq("status", "COMPLETED");
...
const ProfileService = {
   ...
   */ async getProfile (userId) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("profiles").select("*, default_city:cities(name)").eq("id", userId).single();
        if (error) throw error;
        return data;
    },
    /**
   ...
   */ async requestAccountDeletion () {
        const { data: { user } } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getUser();
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].rpc("request_account_deletion");
        if (error) throw error;
        if (user) {
            AuditLogService.logAction({
                salon_id: "",
   ...
   */ async getActiveSessions (userId) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("user_sessions").select("*").eq("user_id", userId).eq("is_revoked", false).order("last_active_at", {
            ascending: false
        });
        if (error) throw error;
        return data || [];
   ...
   */ async terminateSession (sessionId) {
        const { data: { user } } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getUser();
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("user_sessions").update({
            is_revoked: true
        }).eq("id", sessionId);
        if (error) throw error;
        if (user) {
...
"[project]/services/db.ts [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$db$2f$db_appointments$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/db/db_appointments.ts [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$db$2f$db_support$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/db/db_support.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$db$2f$db_user$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/db/db_user.ts [app-client] (ecmascript)");
;
;
;
;
...
"[project]/context/ActiveBranchContext.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const ActiveBranchContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(undefined);
function ActiveBranchProvider({ children }) {
    ...
    const [activeBranch, setActiveBranchState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ActiveBranchProvider.useEffect": ()=>{
            if (user) {
                loadBranches();
            }
        }
    ...
    const loadBranches = async ()=>{
        ...
        try {
            setLoading(true);
            const salons = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$db$2f$db_salon$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SalonDataService"].getSalonsByOwner(user.id);
            setBranches(salons);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ActiveBranchContext.Provider, {
        value: {
            activeBranch,
            setActiveBranch,
            branches,
...
_s(ActiveBranchProvider, "wdrv4fRkcoVbOFN44QVk5yaqY2c=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
_c = ActiveBranchProvider;
function useActiveBranch() {
    _s1();
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(ActiveBranchContext);
    if (context === undefined) {
        throw new Error('useActiveBranch must be used within an ActiveBranchProvider');
    }
    return context;
}
_s1(useActiveBranch, "b9L3QQ+jgeyIrH0NfHrJ8nn7VMU=");
var _c;
__turbopack_context__.k.register(_c, "ActiveBranchProvider");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/context/BookingContext.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function BookingProvider({ children, salonId }) {
    ...
    const [appointmentId, setAppointmentId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    // Auto-fetch salon if salonId is provided
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useEffect({
        "BookingProvider.useEffect": ()=>{
            if (salonId) {
                const fetchSalon = {
                    "BookingProvider.useEffect.fetchSalon": async ()=>{
                        setLoading(true);
                        try {
                ...
                }["BookingProvider.useEffect.fetchSalon"];
                fetchSalon();
            }
        }
    }["BookingProvider.useEffect"], [
...
_s(BookingProvider, "gzkt8DJTo+W18sSAznK0GvtNDz4=");
_c = BookingProvider;
function useBooking() {
    _s1();
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/context/AuthContext.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$TenantContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/context/TenantContext.tsx [app-client] (ecmascript)");
...
function Providers({ children }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuthProvider"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$context$2f$TenantContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TenantProvider"], {
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$context$2f$ActiveBranchContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ActiveBranchProvider"], {
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$context$2f$BookingContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BookingProvider"], {
                    children: children
                }, void 0, false, {
...
//# sourceMappingURL=_f3049d33._.js.map