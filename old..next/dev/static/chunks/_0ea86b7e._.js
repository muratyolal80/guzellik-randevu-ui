...
"[project]/app/booking/[id]/staff/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function StaffSelection() {
    ...
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const id = params.id;
    const { salon: bookingSalon, setSalon: setBookingSalon, selectedServices, setSelectedServices, selectedStaff: bookingStaff, setSelectedStaff: setBookingStaff, setAppointmentId: setContextAppointmentId, resetBooking } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$BookingContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBooking"])();
    ...
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [selectedStaffId, setSelectedStaffId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(bookingStaff?.id || null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "StaffSelection.useEffect": ()=>{
            const fetchData = {
                "StaffSelection.useEffect.fetchData": async ()=>{
                    if (!id) return;
                    setLoading(true);
                    try {
                        // Parallel requests: Salon, Staff, and potentially Service if rescheduling
                        const requests = [
                            !bookingSalon || bookingSalon.id !== id ? __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$db$2f$db_salon$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SalonDataService"].getSalonById(id) : Promise.resolve(bookingSalon),
                            __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$db$2f$db_staff$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StaffService"].getStaffBySalon(id)
                        ];
                        ...
                        if (rescheduleServiceId && (selectedServices.length === 0 || selectedServices[0].id !== rescheduleServiceId)) {
                            requests.push(__TURBOPACK__imported__module__$5b$project$5d2f$services$2f$db$2f$db_staff$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ServiceService"].getServiceById(rescheduleServiceId));
                        }
                        ...
                        const mappedStaff = staffData.map({
                            "StaffSelection.useEffect.fetchData.mappedStaff": (s)=>({
                                    ...s,
                        ...
                        }["StaffSelection.useEffect.fetchData.mappedStaff"]);
                        setStaff(mappedStaff);
                        // Handle Staff Pre-selection
                        if (rescheduleStaffId && (!bookingStaff || bookingStaff.id !== rescheduleStaffId)) {
                            const staffMember = mappedStaff.find({
                                "StaffSelection.useEffect.fetchData.staffMember": (s)=>s.id === rescheduleStaffId
                            }["StaffSelection.useEffect.fetchData.staffMember"]);
                            if (staffMember) {
            ...
            }["StaffSelection.useEffect.fetchData"];
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    selectedStaffId === 'any' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: staff.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            lineNumber: 215,
                                            columnNumber: 17
                                        }, this) : staff.map((s)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    selectedStaffId === s.id && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    s.isOnline && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(StaffSelection, "bDtAzpZvSypkn2MrwNNX9/WjrC0=", false, function() {
    return [
...
_c = StaffSelection;
var _c;
__turbopack_context__.k.register(_c, "StaffSelection");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_0ea86b7e._.js.map