...
function NotificationCenter() {
    ...
    const fetchNotifications = async ()=>{
        ...
        try {
            setLoading(true);
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NotificationService"].getNotifications(user.id);
    ...
    const handleMarkAsRead = async (id)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NotificationService"].markAsRead(id);
    ...
    const handleMarkAllAsRead = async ()=>{
        if (!user) return;
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NotificationService"].markAllAsRead(user.id);
            ...
            const fetchMenuData = {
                "Layout.useEffect.fetchMenuData": async ()=>{
                    try {
                        ...
                        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MasterDataService"].getNavMenuData();
...
"[project]/lib/geocoding.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/admin/salons/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/db.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$geocoding$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/geocoding.ts [app-client] (ecmascript)");
...
function SalonManager() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SalonManager.useEffect": ()=>{
            const fetchData = {
                "SalonManager.useEffect.fetchData": async ()=>{
                    setLoading(true);
                    try {
            ...
            }["SalonManager.useEffect.fetchData"];
            fetchData();
        }
    }["SalonManager.useEffect"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SalonManager.useEffect": ()=>{
            const loadDistricts = {
                "SalonManager.useEffect.loadDistricts": async ()=>{
                    if (editingSalon?.city) {
                        const selectedCityData = cities.find({
                            "SalonManager.useEffect.loadDistricts.selectedCityData": (c)=>c.name === editingSalon.city
                        }["SalonManager.useEffect.loadDistricts.selectedCityData"]);
                        if (selectedCityData) {
                            // Update coordinates from DB if they exist
                            if (selectedCityData.latitude && selectedCityData.longitude && !editingSalon.id) {
                                setEditingSalon({
                                    "SalonManager.useEffect.loadDistricts": (prev)=>prev ? {
                                            ...prev,
                                            coordinates: {
                                ...
                                }["SalonManager.useEffect.loadDistricts"]);
                            }
                            ...
                            setAvailableDistricts(districtsData.map({
                                "SalonManager.useEffect.loadDistricts": (d)=>d.name
                            }["SalonManager.useEffect.loadDistricts"]));
                        }
                    } else {
                        setDistricts([]);
    ...
    const handleSearchAddress = async ()=>{
        ...
        setIsSearching(true);
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$geocoding$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GeocodingService"].searchAddress(searchQuery);
    ...
    const handleSave = async (e)=>{
        ...
        try {
            ...
            if (!editingSalon.id) {
                ...
                const { data: { user } } = await (await __turbopack_context__.A("[project]/lib/supabase.ts [app-client] (ecmascript, async loader)")).supabase.auth.getUser();
                if (user) {
                    salonPayload.owner_id = user.id;
                }
                console.log('Creating salon with payload:', salonPayload);
                await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SalonDataService"].createSalon(salonPayload);
            } else {
                console.log('Updating salon with id:', editingSalon.id, 'payload:', salonPayload);
                await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SalonDataService"].updateSalon(editingSalon.id, salonPayload);
            }
            setIsModalOpen(false);
            setEditingSalon(null);
            // Refresh list
            const salonsData = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SalonDataService"].getSalons();
            setSalons(salonsData);
    ...
    const handleDelete = async (id)=>{
        if (confirm('Bu salonu silmek istediğinize emin misiniz?')) {
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SalonDataService"].deleteSalon(id);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$AdminLayout$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AdminLayout"], {
        children: [
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                            ...
                            children: loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                ...
                                lineNumber: 265,
                                columnNumber: 29
                            }, this) : salons.map((salon)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
            ...
            isModalOpen && editingSalon && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: salonTypes.map((type)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
...
_s(SalonManager, "POVUmBRQBgFRbcahJUGBaGEIDhw=");
_c1 = SalonManager;
var _c, _c1;
__turbopack_context__.k.register(_c, "AdminSalonMap");
__turbopack_context__.k.register(_c1, "SalonManager");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_4c256e45._.js.map