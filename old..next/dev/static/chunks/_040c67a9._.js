...
const LimitEnforcer = {
     ...
     */ async ensureLimit (salonId, resourceType) {
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SubscriptionService"].checkLimit(salonId, resourceType);
        if (!result.allowed) {
     ...
     */ async ensureFeature (salonId, featureName) {
        const sub = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SubscriptionService"].getSalonSubscription(salonId);
...
const StaffService = {
   ...
   */ async createStaff (staffData, customWorkingHours) {
        ...
        if (staffData.salon_id) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$limits$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LimitEnforcer"].ensureLimit(staffData.salon_id, 'staff');
        }
...
function ActiveBranchProvider({ children }) {
    ...
    const loadBranches = async ()=>{
        ...
        try {
            setLoading(true);
            const salons = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SalonDataService"].getSalonsByOwner(user.id);
            setBranches(salons);
                ...
                const fetchSalon = {
                    "BookingProvider.useEffect.fetchSalon": async ()=>{
                        ...
                        try {
                            ...
                            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SalonDataService"].getSalonById(salonId);
                            if (data) {
                                setSalon(data);
                            }
                        } catch (err) {
...
//# sourceMappingURL=_040c67a9._.js.map