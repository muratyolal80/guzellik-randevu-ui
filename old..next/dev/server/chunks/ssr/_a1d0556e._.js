module.exports = [
"[project]/app/customer/favorites/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function FavoritesPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function fetchFavorites() {
            try {
                setLoading(true);
                const data = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["FavoriteService"].getUserFavorites();
                setFavorites(data || []);
            } catch (error) {
    ...
    const removeFavorite = async (salonId, e)=>{
        ...
        try {
            ...
            if (!user) return;
            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["FavoriteService"].toggleFavorite(user.id, salonId);
...
//# sourceMappingURL=_a1d0556e._.js.map