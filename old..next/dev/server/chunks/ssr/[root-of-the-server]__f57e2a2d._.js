...
;
const supabaseUrl = ("TURBOPACK compile-time value", "http://127.0.0.1:8000") || '';
const supabaseAnonKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyb2xlIjoiYW5vbiIsImlzcyI6InN1cGFiYXNlIiwiaWF0IjoxNzY3MzcyMTU3LCJleHAiOjE5MjUwNTIxNTd9.Frv7rg6d7kXV1-sEDew5aIkGDk6xE1vE0UvM1Bo6tvU") || '';
...
const LimitEnforcer = {
     ...
     */ async ensureLimit (salonId, resourceType) {
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SubscriptionService"].checkLimit(salonId, resourceType);
        if (!result.allowed) {
     ...
     */ async ensureFeature (salonId, featureName) {
        const sub = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SubscriptionService"].getSalonSubscription(salonId);
...
const SalonDataService = {
   ...
   */ async createSalon (salon, customHours, initialServices) {
        ...
        if (existingSalons && existingSalons.length > 0) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$limits$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LimitEnforcer"].ensureLimit(existingSalons[0].id, 'branch');
        }
...
const StaffService = {
   ...
   */ async createStaff (staffData, customWorkingHours) {
        ...
        if (staffData.salon_id) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$limits$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LimitEnforcer"].ensureLimit(staffData.salon_id, 'staff');
        }
...
const GalleryService = {
   ...
   */ async addGalleryImage (image) {
        ...
        if (image.salon_id) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$limits$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LimitEnforcer"].ensureLimit(image.salon_id, 'gallery_photo');
        }
...
const SubscriptionService = {
   ...
   */ async getSalonSubscription (salonId) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('subscriptions').select('*, subscription_plans(*)').eq('salon_id', salonId).maybeSingle();
        if (error) throw error;
        return data;
    },
    /**
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f57e2a2d._.js.map