...
const SubscriptionService = {
   ...
   */ async getSalonSubscription (salonId) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabase"].from('subscriptions').select('*, subscription_plans(*)').eq('salon_id', salonId).maybeSingle();
        if (error) throw error;
        return data;
    },
    /**
...
//# sourceMappingURL=_1379b144._.js.map