...
function StaffSelection() {
    ...
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRouter"])();
    const id = params.id;
    const { salon: bookingSalon, setSalon: setBookingSalon, selectedServices, setSelectedServices, selectedStaff: bookingStaff, setSelectedStaff: setBookingStaff, setAppointmentId: setContextAppointmentId, resetBooking } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$BookingContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useBooking"])();
    ...
    // URL parameters for rescheduling
    const rescheduleServiceId = searchParams.get('serviceId');
    const rescheduleStaffId = searchParams.get('staffId');
    const appointmentId = searchParams.get('appointmentId');
    // Fetch data and handle deep linking (rescheduling)
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchData = async ()=>{
            ...
            try {
                ...
                const requests = [
                    !bookingSalon || bookingSalon.id !== id ? __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$db$2f$db_salon$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SalonDataService"].getSalonById(id) : Promise.resolve(bookingSalon),
                    __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$db$2f$db_staff$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["StaffService"].getStaffBySalon(id)
                ];
                ...
                if (rescheduleServiceId && (selectedServices.length === 0 || selectedServices[0].id !== rescheduleServiceId)) {
                    requests.push(__TURBOPACK__imported__module__$5b$project$5d2f$services$2f$db$2f$db_staff$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ServiceService"].getServiceById(rescheduleServiceId));
                }
                ...
                if (rescheduleStaffId && (!bookingStaff || bookingStaff.id !== rescheduleStaffId)) {
                    const staffMember = mappedStaff.find((s)=>s.id === rescheduleStaffId);
                    if (staffMember) {
                        setSelectedStaffId(staffMember.id);
                        setBookingStaff(staffMember);
                    }
                }
            } catch (error) {
        ...
        // Set appointment ID if rescheduling to update instead of creating new
        if (appointmentId) {
            setContextAppointmentId(appointmentId);
        }
        fetchData();
    }, [
        id,
        ...
        rescheduleStaffId,
        appointmentId
    ]); // Removed context state from dependencies
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                        ...
                                                                        children: s.bio || `${s.specialty} konusunda uzman.`
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/app/booking/[id]/staff/page.tsx",
                                                                        lineNumber: 243,
                                                                        columnNumber: 25
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bea6e4ee._.js.map