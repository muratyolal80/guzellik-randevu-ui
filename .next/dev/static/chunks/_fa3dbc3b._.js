...
function StaffSelection() {
    ...
    const id = params.id;
    const { salon: bookingSalon, setSalon: setBookingSalon, selectedService, selectedStaff: bookingStaff, setSelectedStaff: setBookingStaff } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$BookingContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBooking"])();
                ...
                "StaffSelection.useEffect.fetchData": async ()=>{
                    ...
                    try {
                        const [salonData, staffData] = await Promise.all([
                            bookingSalon || __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SalonDataService"].getSalonById(id),
                            __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StaffService"].getStaffBySalon(id)
                        ]);
                        if (salonData) {
                            setSalon(salonData);
                            if (!bookingSalon) {
...
_s(StaffSelection, "dml6V06bHfOU6rhWtI44n3B5BZA=", false, function() {
    return [
...
//# sourceMappingURL=_fa3dbc3b._.js.map