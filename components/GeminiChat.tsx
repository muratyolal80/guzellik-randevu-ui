...
export const GeminiChat: React.FC = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { id: '1', sender: 'bot', text: 'Merhaba! Ben Güzellik Randevu asistanıyım. Size en uygun salonu veya uzmanı bulmanızda nasıl yardımcı olabilirim?' }
  ]);
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      // Using the recommended model from instructions for "Basic Text Tasks"
